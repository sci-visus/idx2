...
Decode1()
{
  ...
  // Level 1, mask 128 = 128 x 128 x 128 (same resolution but slightly less accurate than Level 0,
  // mask 1)
  // ...
  // Level 1, mask 1   =  64 x  64 x  64
  P.DecodeAccuracy = 0.001;
  P.DecodeExtent = idx2::extent(Idx2.Dims3); // get the whole volume
  // P.DecodeExtent = idx2::extent(idx2::v3i(10, 20, 30), idx2::v3i(100, 140, 160)); // get a
